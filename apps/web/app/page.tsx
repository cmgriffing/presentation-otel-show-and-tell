...
const handleClick = async () => {
  ...
  span?.setAttribute("NEXT_CLICK_KEY", "NEXT_CLICK_VALUE");

  span?.addEvent("NEXT_CLICK_EVENT", {
    NEXT_CLICK_EVENT_KEY: "NEXT_CLICK_EVENT_VALUE",
  });
};
...
export default function Page(): JSX.Element {
  ...
  console.log("Span in render", span);

  logger.info("LOGGING IN PAGE RENDER");
